...
import { PROJECT_PUBLIC_ROUTES } from "./routes";
...
export const OrderTradeInfo = {
    [OrderStepIds.ORDER_INFO]: {
        ...
        to: PROJECT_PUBLIC_ROUTES["ORDER_INFO"],
    ...
    [OrderStepIds.ACCOUNT_DETAILS]: {
        ...
        to: PROJECT_PUBLIC_ROUTES["ORDER_ACCOUNT_DETAILS"],
        allowSteps: [OrderStepIds.ORDER_INFO],
    ...
    [OrderStepIds.AWAITING_FOR_DELIVERY]: {
        ...
        to: PROJECT_PUBLIC_ROUTES["ORDER_AWAITING_FOR_DELIVERY"],
        allowSteps: [OrderStepIds.ORDER_INFO, OrderStepIds.ACCOUNT_DETAILS],
        title: "Coin transfer",
        step: 3,
    },
};
