...
>(({ side = "right", className, children, ...props }, ref) => (
    <Portal>
        ...
        >
            {children}
            <SheetPrimitive.Close className="absolute right-10 top-10 rounded-sm opacity-70 ring-offset-background transition-opacity hover:opacity-100 disabled:pointer-events-none data-[state=open]:bg-secondary">
