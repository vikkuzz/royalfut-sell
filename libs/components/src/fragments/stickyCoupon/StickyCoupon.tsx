                ...
                <div className="w-full flex flex-col p-[28px_20px] z-10 bg-[url('/image/bottom-right-coin.png')] bg-right-bottom bg-no-repeat">
                    ...
                    <div className="flex flex-col md:flex-row md:gap-[16px] md:pt-[16px]">
                        <Link href={"/order"} className="w-full">
                            <GradientButton className="flex justify-center items-center w-full text-2xl my-[16px] h-[64px] font-semibold md:my-0 rounded-xl bg-primary">
                                Buy Coins
                            </GradientButton>
                        </Link>
                        <Button
                            onClick={copy}
                            className={cn(
                                "flex relative text-xl rounded-2xl transition-all duration-300 font-semibold w-full hover:bg-white-5 h-[64px]",
                                {
                            ...
                            <label className="flex bg-transparent cursor-pointer">
                                ...
                                <img
                                    alt="copy"
                                    src={`${!copyText ? `/image/content_copy.svg` : `/image/done_green.svg`}`}
