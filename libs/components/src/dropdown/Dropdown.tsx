        ...
        >
            <HoverCard.Trigger asChild>
                <button className="flex gap-2 text-base font-semibold items-center bg-white/5 w-fit py-3 px-10 rounded-2xl hover:bg-white-10">
                    ...
                    <ArrowDownFilledIcon
                        className={
                            cn("block text-white fill-white bg-transparent w-[24px] h-[24px] min-w-[24px] transition-transform duration-300 group-data-[state=open]:rotate-180 group-data-[state=closed]:rotate-0", {
                                "rotate-180": isOpen,
                                "rotate-0": !isOpen
                            })
                        }
            ...
            <HoverCard.Portal>
                <HoverCard.Content
                    className={cn(cnPickerContent, "flex w-auto flex-col gap-2 z-40")}
                    sideOffset={10}
                >
                    <a
                        ...
                        className="flex items-center pl-2 gap-2 rounded-xl hover:bg-white-10 py-2"
                    >
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center pl-4 gap-2 rounded-xl hover:bg-white-10 py-2"
                    >
                        <Image alt="icon twitter" src={"/img/prime_twitter.svg"} width={24} height={24} className="w-6 h-6"/>
                        Twitter
                    </a>
                    <a
                    ...
                    <button
                        onClick={handleCopy}
                        className="relative flex items-center pl-4 gap-2 rounded-xl hover:bg-white-10 py-2"
                    >
                        <div
                            className={cn(
