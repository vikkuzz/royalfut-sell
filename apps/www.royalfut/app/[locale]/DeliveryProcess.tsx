...
const Card: FC<ICardProps> = ({ picture, desc, title, withArrow = false }) => {
    return (
        <div className="relative flex flex-col items-center space-y-6 mx-auto sm:ml-0 sm:basis-1/3">
            <div className="bg-black-shape overflow-hidden rounded-full w-60 h-60 relative mx-auto">
                <Image
                    alt=""
                    className={cn(
            ...
            {withArrow && (
                <div className="absolute -left-5 -bottom-[15%] translate-y-full sm:left-[auto] sm:translate-y-0 sm:bottom-[auto] sm:right-0 sm:translate-x-[60%] sm:top-1/4">
...
const DeliveryProcess = () => {
    ...
    return (
        <div className="flex flex-col gap-12">
            ...
            <div className="flex flex-col sm:flex-row w-full justify-around space-y-11 gap-6 sm:space-y-0">
                <Card
                    picture={{
