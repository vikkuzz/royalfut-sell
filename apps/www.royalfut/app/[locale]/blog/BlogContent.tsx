...
import { redirectedCard, tags } from "@royalfut/collections";
import { LoadingFormBtn } from "@royalfut/ui";

const BlogContent = ({ posts }: { posts: Array<ICard> }) => {
