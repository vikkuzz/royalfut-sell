...
import { BorderedBox, GradientButtonRegular } from "@royalfut/ui";
...
const PromoBanner: FC<IPromoBannerProps> = ({ rate }) => {
    return (
        <BorderedBox
            ...
            <div className="flex flex-col-reverse sm:flex-row gap-17 sm:gap-4">
                <div className="basis-2/3 flex flex-col justify-between gap-10 sm:gap-12">
                    <div className="flex flex-col">
                        ...
                        <AnimatedHeadingSection
                            h1="Safest option to buy"
                            h2="FIFA 24 Coins"
                            isPrimary={false}
                            className="mt-6 space-y-1 items-start justify-start"
                        />
                    </div>
                    <div className="relative gap-6 sm:gap-0 flex flex-col sm:flex-row justify-start w-full sm:w-max">
                ...
                <div className="basis-1/3">
                    <div className="relative h-full flex items-center">
                        ...
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-3/5 aspect-square rounded-[4rem] -rotate-[25deg] z-[2]">
                            <div
                                className={cn(
                                    "absolute w-max h-max left-[5%] -top-[15%]"
                                )}>
                                <div
                                    className={
                        ...
                        <div
                            className={cn(
                                "absolute w-max h-max left-[12%] top-[70%]"
                            )}>
                            <div
                                className={
                                    " relative w-20 aspect-[20/19] -rotate-[35deg] shine-bright-coin before:bottom-2 before:right-5 before:opacity-75"
                                }>
                                <Image
