...
import { Button, EmblaCarouselLayout } from "@royalfut/ui";
import { useUpdate, useMount } from "@lilib/hooks";
import { PlayPlayerIcon, PausePlayerIcon } from "@royalfut/icons";
import {
    NextButton,
    PrevButton,
    BaseButton,
    usePrevNextButtons,
} from "./_embla/EmblaCarouselArrowButtons";
import { useDotButton } from "./_embla/EmblaCarouselDotButton";
...
const EmblaCarousel: FC<IPropType> = ({ slides, options }) => {
...
interface IPromoCardCarouselProps {
    cards: Array<ICarouselPromoCards>;
}

const PromoCardCarousel: FC<IPromoCardCarouselProps> = ({ cards }) => {
    return (
        <>
