                ...
                if (res?.errors) {
                    if (res.errors.email) {
                        dispatch(
                            showMessage({
                                status: "error",
                                text: `${t`seo94`.replace("[[X]]", email.current.value)}`,
                            })
                        );
                        return;
                    }
            ...
            <div className={`${styles.burger_menu}`} ref={menu}>
                ...
                <div
                    ...
                    {auth ? (
                        ...
                        <Link href={"/login"}>
                            <MenuItem text={t`seo5`} />
                        </Link>
                    )}
                    <Menu
                        title={t`locales.profile`}
                        menuItems={profileItems}></Menu>
                    <div className={`${window.innerWidth > 1024 && "hide"}`}>
                        <Menu title={t`a5`} menuItems={menuItems}>
                            <OptionWithItems />
                        </Menu>
                    </div>
                </div>
                            ...
                            <form className={styles.auth_form}>
                                ...
                                <fieldset
                                    ...
                                    <input
                                        ...
                                        className={styles.auth_userdata}
                                        type="password"
                                        placeholder={t`locales.modalSignPassword`}></input>
                                    <button
                                        ref={viewPassBtn}
