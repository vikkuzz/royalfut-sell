            ...
            <div className={`${styles.wrapper_paddings}`}>
                                ...
                                <div className={`${styles.footer_infowrapper}`}>
                                    <div
                                        ...
                                        <Link
                                            href={`/delivery`}
                                            className={`${styles.footer_info_font} white-40 ${styles.footer_flexstart}`}>
                                            {/* <Trans>locales.footerLinkDelivery</Trans> */}
                                            {t("footer.delivery")}
                                        </Link>
                                    </div>
                                    <div
                                        ...
                                        <Link
                                            href={`/payments`}
                                            className={`${styles.footer_info_font} white-40 ${styles.footer_flexstart}`}>
                                            {/* <Trans>locales.footerLinkPayment</Trans> */}
                                            {t("footer.payment")}
                                        </Link>
                                    </div>
                                    <div
                                        ...
                                        <Link
                                            href={`/terms`}
                                            className={`${styles.footer_info_font} white-40 ${styles.footer_flexstart}`}>
                                            {/* <Trans>locales.footerLinkTerms</Trans> */}
                                            {t("footer.terms")}
                                        </Link>
                                    </div>
                                    <div
                ...
                <div className={`${styles.footer_icons_container}`}>
                    <div className={`${styles.footer__svg_wrapper}`}>
                        ...
                        {/* <div className={`${styles.footer__apple} ${styles.footer_svg}`}></div>
                        <div className={`${styles.footer__googlePay} ${styles.footer_svg}`}></div> */}
                    </div>
                    <Link
                        href={"/"}
                        className={`${styles.footer_info_font} white-40 ${styles.footer_flexstart} ${styles.royalfut}`}>
                        ROYALFUT {format(new Date(), "yyyy")}
                    </Link>
                </div>
            </div>
        </footer>
