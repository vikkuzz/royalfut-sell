        ...
        <MainContainer
            ...
            <div className={`${styles.app_main}`}>
                <div className={`${styles.desk_h_wrapper}`}>
                    ...
                    <div
                        className={`${styles.aside_wrapper} from-1025-to-1900`}>
                        <Aside stock={stock} />
                    </div>
                </div>
                <div className={`${styles.changer_container}`}>
                        ...
                        <div className={`${styles.demo_wrapper}`}>
                            <div className={`${styles.demo_block}`}>
                                ...
                                <div className={`${styles.text_content}`}>
                                    <h2 className={styles.boost_h2}>
                                        <Trans>aa5</Trans>
                                    </h2>
                                    <span
                                        className={`${styles.boost_description}`}>
                                        <Trans>aa6</Trans>
                                    </span>
                                    <div className={`${styles.wrapper_social}`}>
                                        <span
                                            className={`${styles.title_social}`}>
                                            <Trans>via</Trans>
                                        </span>
                                        <div
                    ...
                    <div
                        className={`${styles.block_bonuses} from-1025-to-1900`}>
                        <BonusBlock />
                    </div>
                </div>
            </div>
