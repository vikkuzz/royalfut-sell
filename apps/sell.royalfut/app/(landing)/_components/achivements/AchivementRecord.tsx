...
const AchivementRecord: FNCN<{ achivement: string; desc: string }> = ({
    ...
    return (
        <div
            ...
            <span className="text-center w-max text-transparent text-[3.5rem] pt-1 -mt-1 font-bold leading-10 pb-3 animate-backgroundPan linear-primary-pan-gradient whitespace-nowrap bg-clip-text webkit-text-fill-transparent">
                {achivement}
            </span>
